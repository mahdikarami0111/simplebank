...
func (q *Queries) GetTransfer(ctx context.Context, id int64) (Transaction, error) {
...
func (q *Queries) ListTransfers(ctx context.Context, arg ListTransfersParams) ([]Transaction, error) {
